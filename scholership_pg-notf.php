...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `noticebrd` ( `notification`, `date`, `link`, `type`) VALUES ('$notification', '$date', '$link', 'scholershippage')";
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Create New Scholarship Page Notification</h4>

                            <div class=" card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="/loginsystem/scholership_pg-notf.php" method="post">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Manage Scholarship Page Notification</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <th><?php echo $date; ?></th>
                                                            <th><?php echo $link; ?></th>
                                                            <td><a href="delete-script_Sch.php?recordId=<?php echo $recordId ?>" class="btn btn-danger btn-sm">Delete</a> </td>
                                                        </tr>
                                                <?php
                                                        $sr++;
                                                    }
