...
<header>
                  ...
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown nv-it">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="ece.php">Electrical & Telecommunication</a>
                        <a class="dropdown-item" href="elc.php">Electrical</a>
                        <a class="dropdown-item" href="mech.php">Machanical</a>
                    ...
                    <li class="nav-item nv-it">
                      <a class="nav-link  nv-lk" href="Default_UC.html">Gallary</a>
                    </li>
                    <li class="nav-item nv-it">
  ...
  <section style="margin-top: 5%;" id="title">
    ...
    <div style="text-align:center;" class="container">
      ...
      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;" class="page-sub-hd">Admission</h2>

    </div>
    <div style="text-align:left; margin-left:15%; margin-bottom:5%;" class="">
      <h1 class="txt-rotate typo">Welcome To Admission Portal</h1>
    </div>
    ...
    <script type="text/javascript">
      document.addEventListener('DOMContentLoaded', function(event) {
        ...
        var dataText = ["Welcome To Admission Portal"];
    ...
    <div class="container">
      <div class="row">
        <div style="background: linear-gradient(100deg, rgba(8,174,234,0.7175245098039216) 0%, rgba(42,245,152,0.8547794117647058) 79%);" class="col-md-6">
          <div style="text-align:center; padding: 2%; margin-top:2%" class="container">

            <h2 class="adm-ntc">Admission Notice</h2>
            <section id="">
    ...
    $strSQL = "SELECT * FROM noticebrd WHERE type = 'admissionpage'";

    $rs = mysqli_query($conn, $strSQL);

    while ($row = mysqli_fetch_array($rs)) {
        //Display Logged user info
        $result = $conn->query("SELECT * FROM noticebrd WHERE type = 'admissionpage'");
    }
    ...
    ?>
        ...
        <div style="padding-left: 80px;padding-right: 80px;" class="col-md-6">
          <div style="margin-top: 3%;margin-bottom: 3%;text-align:center;" class="">
            <h2 style=" margin-bottom: 50px; margin-top: 19px; box-shadow: 5px 10px 18px #888888; padding: 5%;">Video Gallary</h2>
          </div>
          <div class="row">
            <div class="col-6">
              <div style="margin-bottom:3%;" class="vdo-resp">
                <div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/2MpUj-Aua48" allowfullscreen></iframe> </div>
              </div>
              <div style="margin-bottom:3%;" class="vdo-resp">
                <div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/2MpUj-Aua48" allowfullscreen></iframe> </div>
              </div>
    ...
    <hr>
    <div style="text-align:center; margin-top:3%; margin-bottom:3%;" class="">
      <h2>Department Wise Intake</h2>
    </div>
    <div class="container">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>Electronics and Telecommunication Eng.</td>
                <td>I Shift</td>
                <td>00</td>
              </tr>
              <tr>
      ...
      <div class="container int-sec">
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;" class=""> Information Brochure </h5>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;  " class="">Admission Process</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Admission Rules</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;" class="">Help file for Online Application Process</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style="  font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;  " class="">Aadhaar seeding with NPCI mapping form</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Check for Bank Aadhaar Mapping Process</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Instruction for Croping Photo and Signature</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
