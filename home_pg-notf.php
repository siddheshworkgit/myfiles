...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `noticebrd` ( `notification`, `date`, `link`, `type`) VALUES ('$notification', '$date', '$link', 'homepage')";
                   ...
                   <li>
                    ...
                    <li>
                        <a href="faculty.php" aria-expanded="false">
                            <i class="fas fa-users-cog"></i><span class="nav-text">Faculty Management</span>
                        </a>
                    </li>
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Create New Home Page Notification</h4>

                            <div class=" card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="/loginsystem/home_pg-notf.php" method="post">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Manage Home Page Notification</h4>
