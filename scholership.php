...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;0,700;1,300&display=swap"
    rel="stylesheet">
...
<header>
  ...
  <section style="margin-top: 5%;" id="title">
    ...
    <div style="text-align:center;" class="container">
      <h2 style=" font-weight: 900; font-family: 'Montserrat', sans-serif; font-size:3rem;" class="heading">Government
        Polytechnic</h2>
      <h2 style=" font-weight: 900; font-family: 'Montserrat', sans-serif; font-size:3rem;" class="heading">Malvan</h2>
      <h3 style="margin-top: 3%;font-family: 'Ubuntu', sans-serif; font-size:1.3rem;" class="sub-heading">Government
        Institute for diploma engineering programs</h3>

      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;"
        class="page-sub-hd">Scholarship</h2>

    </div>
    <div style="text-align:left; margin-left:15%;" class="">
      <h1 class="txt-rotate typo">Welcome To Scholarship Portal</h1>
    </div>

    <!--JAVA SCRIPT FOR TITLE TYPO-->

    <script type="text/javascript">
      document.addEventListener('DOMContentLoaded', function (event) {
        // array with texts to type in typewriter
        var dataText = ["Welcome To Scholarship Portal"];

        // type one text in the typwriter
        // keeps calling itself until the text is finished
        function typeWriter(text, b, fnCallback) {
          // chekc if text isn't finished yet
          if (b < (text.length)) {
            // add next character to h1
            document.querySelector(".typo").innerHTML = text.substring(0, b + 1) +
              '<span aria-hidden="true"></span>';

            // wait for a while and call this function again for next character
            setTimeout(function () {
              typeWriter(text, b + 1, fnCallback)
            }, 100);
          }
        ...
        function StartTextAnimation(b) {
          if (typeof dataText[b] == 'undefined') {
            setTimeout(function () {
              StartTextAnimation(0);
            }, 20000);
          }
          // check if dataText[i] exists
          if (b < dataText[b].length) {
            // text exists! start typewriter animation
            typeWriter(dataText[b], 0, function () {
              // after callback (and whole text has been animated), start next text
              StartTextAnimation(b + b);
            });
          }
        }
    ...
    <div
      style="text-align:center; padding: 2%;  background: linear-gradient(100deg, rgba(8,174,234,0.7175245098039216) 0%, rgba(42,245,152,0.8547794117647058) 79%); margin-top:2%"
      class="container">

      <h2 class="impdt"><u>Important Dates</u></h2>
      <section id="">
    ...
    $strSQL = "SELECT * FROM noticebrd WHERE type = 'scholershippage'";

    $rs = mysqli_query($conn, $strSQL);

    while ($row = mysqli_fetch_array($rs)) {
        //Display Logged user info
        $result = $conn->query("SELECT * FROM noticebrd WHERE type = 'scholershippage'");
    }
    ...
    ?>
          ...
          <p style="font-family: 'Ubuntu', sans-serif; color: red; font-size:1.5rem; ">Dates Will Announce Soon...</p>
          <?php } ?>
    ...
    <div style="margin-bottom:3%;" class="container">
      <h2 class="ql-txt" style="font-family: 'Fredoka One', cursive; margin-bottom:3%;">Quick Links:</h2>

      <h3 class="nrfsc-txt">New Registration For Scholarship</h3>
    </div>

    <div style="margin-bottom:3%;" class="container">
      <div style="text-align:center;" class="">
        <h4 class="sclinc-txt" style="color: #f4c430;font-family: 'Ubuntu', sans-serif; font-weight:700;">Social Justice
          and Special Assistance Department</h4>
      </div>

      <ul class="sc-lnc-act" style="line-height: 3rem;font-size:1.3rem; padding:0; margin-top:2%;color:red;">
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Government of India Post-Matric Scholarship</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Post-Matric Tuition Fee and Examination Fee
            (Freeship)</li>
        </a>
      </ul>
    </div>
    ...
    <div style="margin-bottom:3%;" class="container">
      <div style="text-align:center;" class="">
        <h4 class="sclinc-txt" style="color: #f4c430;font-family: 'Ubuntu', sans-serif; font-weight:700;">Tribal
          Development Department</h4>
      </div>
      <ul class="sc-lnc-act" style="line-height: 3rem;font-size:1.3rem; padding:0; margin-top:2%;color:red;">
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Post Matric Scholarship Scheme (Government Of
            India )</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Vocational Education Fee Reimbursement</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Tuition Fee & Exam Fee for Tribal Students (
            Freeship)</li>
        </a>
      </ul>
    </div>
    ...
    <div style="margin-bottom:3%;" class="container">
      <div style="text-align:center;" class="">
        <h4 class="sclinc-txt" style="color: #f4c430;font-family: 'Ubuntu', sans-serif; font-weight:700;">Directorate of
          Technical Education</h4>
      </div>
      <ul class="sc-lnc-act" style="line-height: 3rem;font-size:1.3rem; padding:0; margin-top:2%;color:red;">
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Dr. Panjabrao Deshmukh Vasatigruh Nirvah Bhatta
            Yojna</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Rajarshi Chhatrapati Shahu Maharaj Shikshan
            Shulkh Shishyavrutti Yojna</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i> Scheme for State Minority Communities Pursuing
            Higher Professional Education/All Post H.S.C Courses.(Part-I{(Technical Course(DTE)}</li>
        </a>
      </ul>
    </div>
    ...
    <div style="margin-bottom:3%;" class="container">
      <div style="text-align:center;" class="">
        <h4 class="sclinc-txt" style="color: #f4c430;font-family: 'Ubuntu', sans-serif; font-weight:700;">OBC, SEBC,
          VJNT & SBC Welfare Department</h4>
      </div>
      <ul class="sc-lnc-act" style=" line-height: 3rem;font-size:1.3rem; padding:0; margin-top:2%;color:red;">
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Post Matric Scholarship to OBC Students</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Tuition Fees and Examination Fees to OBC Students
          </li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Post Matric Scholarship to SBC Students</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Tuition Fees and Examination Fees to SBC Students
          </li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Post Matric Scholarship to VJNT Students</li>
        </a>
        <a href="#">
          <li><i style="margin-right:2%;" class="far fa-snowflake"></i>Tuition Fees and Examination Fees to VJNT
            Students</li>
        </a>
      </ul>
    </div>
      ...
      <div class="container int-sec">
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;" class=""> Forgot Username</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
              </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;  " class="">Pop Up Blocker Guidance
                </h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Forgot Password</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;" class="">Help file for Online
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style="  font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;  " class="">Aadhaar seeding with
                  NPCI mapping form</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Check for Bank Aadhaar
                  Mapping Process</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Instruction for Croping
                  Photo and Signature</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/pdf.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota">Go To PDF</a>
          ...
          <div class="row">
            ...
            <div class="col-md-4 abt-us-ftr">
              ...
              <p style="text-align:justify;">Government Polytechnic, Malvan was established in 1985. This Institute
                ...
                level. At present, the Institute
