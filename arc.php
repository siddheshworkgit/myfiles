...
$committee_id = 3; // set to the ID of the committee you are updating
...
$positions = [
    ...
    "Non-teaching Staff Member" => "Non-teaching Staff Member",
    "Male Student Member" => "Male Student Member",
    "Female Student Membere" => "Female Student Membere",
];
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card">
                                <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Anti Ragging Committee
                                </h4>
