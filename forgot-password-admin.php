		...
		<div class="sign-up-container">
			<div class="signup-align">
				<form name="login" action="" method="post" onsubmit="return loginValidation()">
					<div class="signup-heading">Webmaster Password Recovery</div>
					<?php
				...
				<div>
					...
					<ul style="color:red;">
						<li>*This Portal is used for resetting the password of Webmaster.</li><br>
						<li>*Enter The Username registered to webmaster portal.</li><br>
						<li>*Password Reset link will be send on registered email address.</li><br>
						<li>*If you don't get the reset email link kindly check the email that is linked with account.</li><br>
						<li>*If any problem arrise please free to contact Dev Team.</li><br>
					</ul>
