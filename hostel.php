...
<body>
  ...
  <section style="margin-top: 5%;" id="title">
    ...
    <div class="container landing-screen-int">
      ...
      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;" class="page-sub-hd">Hostel</h2>

    </div>

<div style="margin-left:8%; margin-bottom:2%; font-family: 'Montserrat', sans-serif;" class="">
...
<div style="margin-left:8%;font-family: 'Montserrat', sans-serif;" class="gvct">
  <h2>Governing Comitee</h2>
</div>
<?php
...
<div style=" margin-top:3%;" class="container">
  ...
  <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          <td><?php echo $row['rectorb'] ?></td>
          <td>Rector Boys Hostel</td>
          <td>1234567890</td>
        </tr>
        <tr>
          <td><?php echo $row['rectorg'] ?></td>
          <td>Rector Girls Hostel</td>
          <td>1234567890</td>
        </tr>
        <tr>
          <td><?php echo $row['wardenb1'] ?></td>
          <td>Warden Boys Hostel</td>
          <td>1234567890</td>
        </tr>
        <tr>
          <td><?php echo $row['wardenb2'] ?></td>
          <td>Warden Boys Hostel</td>
          <td>1234567890</td>
        </tr>
        <tr>
          <td><?php echo $row['wardeng1'] ?></td>
          <td>Warden Girls Hostel</td>
          <td>1234567890</td>
        </tr>
        <tr>
          <td><?php echo $row['wardeng2'] ?></td>
          <td>Warden Girls Hostel</td>
          <td>1234567890</td>
        </tr>
...
<div style="text-align:center;font-family: 'Montserrat', sans-serif;margin-top:5%;" class="container">
  <h2>Intake</h3>
</div>

<div style="margin-left:8%; margin-top:5%" class="">
  <h3 style="font-family: 'Montserrat', sans-serif;">Boys Hostel</h3>
</div>
<div style=" margin-top:3%;" class="container">
  <table class="table table-bordered">
    <thead>
      <tr>
        <th>Total Hostel Seats</th>
        <th>FY Boys</th>
        <th>SY Boys</th>
        <th>TY Boys</th>
...
<div style="margin-left:8%; margin-top:5%" class="">
  <h3 style="font-family: 'Montserrat', sans-serif;">Girls Hostel</h3>
</div>
<div style=" margin-top:3%;" class="container">
  <table class="table table-bordered">
    <thead>
...
<div style="margin-top:5%;" class="container">
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <td>Demand Draft Details (DD)</td>
        <td>Government Polytechnic Malvan(Hostel)</td>

      </tr>
      <tr>
        <td>Hostel Rent(Single Acadamic Year)</td>
        <td>0000 (INR)</td>
