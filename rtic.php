...
$committee_id = 5; // set to the ID of the committee you are updating

// positions and their corresponding designations
$positions = [
    "Appealing Officer" => "Appealing Officer",
    "Information Officer" => "Information Officer",
    "Asst. Information officer" => "Asst. Information officer",
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card">
                                <h4 style=" margin-left: 3%; margin-top: 3%;" class="">RTI Committee
                                </h4>
