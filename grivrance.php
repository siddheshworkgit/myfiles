...
<body>
  ...
  <section style="margin-top: 5%;" id="title">
    ...
    <div style="text-align:center;" class="container">
      <h2 style=" font-weight: 900; font-family: 'Montserrat', sans-serif; font-size:3rem;" class="heading">Government Polytechnic</h2>
      ...
      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;" class="page-sub-hd">Grievence</h2>

    </div>
    <div style="text-align:left; margin-left:15%;" class="">
      <h1 class="txt-rotate typo">Welcome To Grievence Portal</h1>
    </div>
    ...
    <script type="text/javascript">
      document.addEventListener('DOMContentLoaded', function(event) {
        ...
        var dataText = ["Welcome To Grivrance Portal"];
        ...
        function typeWriter(text, b, fnCallback) {
          ...
          if (b < (text.length)) {
            ...
            document.querySelector(".typo").innerHTML = text.substring(0, b + 1) + '<span aria-hidden="true"></span>';
...
<div style="text-align:center;margin-top:4%;margin-bottom:4% ;" class="container">
<h2 style="font-size:1.6rem;" >Online Grievance Submission</h2>
<a href=" " target="_blank" style="margin:3%;" class="btn btn-warning" role="button">Press Here</a>
</div>
    <div class="container">
      ...
      <div class="container int-sec">
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;" class=""> Grievance Redressal Committee</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/grvc.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota" data-toggle="modal" data-target="#grc1">View</a>
              </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;  " class="">Women Grievance Redressal Committee</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/grvc.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota" data-toggle="modal" data-target="#grc2">View</a>
              </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">Anti Ragging Committee</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/ragg.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota" data-toggle="modal" data-target="#grc3">View</a>
              </div>
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;" class="">Anti Ragging Squad</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/ragg.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota" data-toggle="modal" data-target="#grc4">View</a>
              </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style="  font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif;  " class="">RTI Committee</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/rti.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota" data-toggle="modal" data-target="#grc5">View</a>
              </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi-ota">
                <h5 style=" font-size: 1.5rem;   font-family: 'Ubuntu', sans-serif; " class="">SC/ST Committee</h5>
                <div style="margin-bottom:4%" class="">
                  <img style="  opacity: 0.5;" src="images/scst.png" alt="">
                </div>
                <a href="#" class="btn btn-warning navi-btn-ota" data-toggle="modal" data-target="#grc6">View</a>
              </div>
...
// Define an array of committees with their respective IDs and titles
$committees = [
...
// Static designations for each committee
$static_designations = [
    1 => [
        "CHAIRMAN",
        "MEMBER",
...
<!-- Modals for each committee -->
<?php foreach ($committees as $committee_id => $committee_title): ?>
    <div class="modal fade" id="grc<?php echo $committee_id; ?>" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo htmlspecialchars($committee_title); ?></h4>
                ...
                <div class="modal-body">
                    <div class="container">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                // Fetch members for the current committee_id
                                $members_sql = "SELECT name FROM committee_members WHERE committee_id = ?";
                                $members_stmt = $conn->prepare($members_sql);
                                $members_stmt->bind_param("i", $committee_id);
                                $members_stmt->execute();
                                $members_result = $members_stmt->get_result();

                                // Output each member dynamically with static designations
                                $index = 0;
                                while ($member = $members_result->fetch_assoc()): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($member['name']); ?></td>
                                        <td><?php echo $static_designations[$committee_id][$index]; ?></td>
                                    </tr>
                                    <?php $index++; ?>
                                <?php endwhile; ?>

                                <?php
                                // Close prepared statement for current committee
                                $members_stmt->close();
                                ?>
                            </tbody>
                        </table>
