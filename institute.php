...
<body>
  ...
  <section id="title">
    ...
    <div class="container landing-screen-int">
      <h1 style=" font-weight: 900; font-family: 'Montserrat', sans-serif; font-size:3rem;" class="heading">Government
        Polytechnic</h1>
      ...
      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;"
        class="page-sub-hd">Institute</h2>
      ...
      <div class="container int-sec">
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi">
                <h5 class="card-title-navi">Alumni</h5>
                <p class="card-text-navi">Click on the below card button to redirect the Alumani portal to view the
                  content of page.</p>
                <a href="alumni.html" class="btn btn-primary navi-btn">Go To Page</a>
              </div>
              <div class="top-image-card-navi">
                <img src="images/icon/Alumni.png" alt="int-console-img" class="img-responsive">
              </div>
            </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi">
                <h5 class="card-title-navi">Scholarship</h5>
                <p class="card-text-navi">Click on the below card button to redirect the Scholarship portal to view the
                  content of page.</p>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi">
                <h5 class="card-title-navi">Library</h5>
                <p class="card-text-navi">Click on the below card button to redirect the Library portal to view the
                  content of page.</p>
                <a href="Default_UC.html" class="btn btn-primary navi-btn">Go To Page</a>
              </div>
              <div class="top-image-card-navi">
                <img src="images/icon/Library.png" alt="int-console-img" class="img-responsive">
              </div>
            </div>
        ...
        <div class="row int-console">
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi">
                <h5 class="card-title-navi">Hostel</h5>
                <p class="card-text-navi">Click on the below card button to redirect the Hostel portal to view the
                  content of page.</p>
                <a href="hostel.php" class="btn btn-primary navi-btn">Go To Page</a>
              </div>
              <div class="top-image-card-navi">
                <img src="images/icon/Hostel.png" alt="int-console-img" class="img-responsive">
              </div>
            </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi">
                <h5 class="card-title-navi">Gymkhana</h5>
                <p class="card-text-navi">Click on the below card button to redirect the Gymkhana portal to view the
                  content of page.</p>
                <a href="Default_UC.html" class="btn btn-primary navi-btn">Go To Page</a>
              </div>
              <div class="top-image-card-navi">
                <img src="images/icon/gym.png" alt="int-console-img" class="img-responsive">
              </div>
            </div>
          ...
          <div class="col-md-4 int-console">
            ...
            <div class="card card-navi">
              <div class="card-body card-body-navi">
                <h5 class="card-title-navi">Office</h5>
                <p class="card-text-navi">Click on the below card button to redirect the Office portal to view the
                  content of page..</p>
                <a href="Default_UC.html" class="btn btn-primary navi-btn">Go To Page</a>
              </div>
              <div class="top-image-card-navi">
                <img src="images/icon/office.png" alt="int-console-img" class="img-responsive">
              </div>
            </div>
    ...
    <section id="counters-sec">
      <div class="container-fluid cntr-contnr">
        <div class="row">
          <div class="col-md-3 counter-sec-cl">
            <div class="counter-combiner">

              <i class="fas fa-project-diagram icn-cntr"></i> <span class="counter ctr-fnt">39</span><span
                class="unit">+</span>
              <h3 class="sub-line-counter">NO. OF YEARS FROM INCEPTION</h3>
          ...
          <div class="col-md-3 counter-sec-cl">
            <div class="counter-combiner">
              ...
              <i class="fas fa-university icn-cntr"></i> <span class="counter ctr-fnt">6</span><span
                class="unit">+</span>
              <h3 class="sub-line-counter">ACARES OF CAMPUS AREA</h3>
          ...
          <div class="col-md-3 counter-sec-cl">
            <div class="counter-combiner">
              ...
              <i class="fas fa-user-graduate icn-cntr"></i> <span class="counter ctr-fnt">10000</span><span
                class="unit">+</span>
              <h3 class="sub-line-counter">DIPLOMA STUDENT PASSED TILL DATE</h3>
          ...
          <div class="col-md-3 counter-sec-cl">
            <div class="counter-combiner">
              ...
              <i class="fas fa-chalkboard-teacher icn-cntr"></i> <span class="counter ctr-fnt">60</span><span
                class="unit">+</span>
              <h3 class="sub-line-counter">TEACHING AND NON TEACHING STAFF</h3>
