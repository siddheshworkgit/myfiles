...
$committee_id = 2; // set to the ID of the committee you are updating
...
$positions = [
    ...
    "Member 2" => "Member",
    "Member 3" => "Member",
    "Honorary Member 1" => "Honorary Member",
    "Honorary Member 2" => "Honorary Member",
    "Honorary Member 3" => "Honorary Member",
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card">
                                <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Women Grievance Redressal Committee
                                </h4>
