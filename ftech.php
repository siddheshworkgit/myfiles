...
<body>
  ...
  <section style="margin-top: 5%;" id="title">
    ...
    <section id="dep-clg">
      ...
      <div class="container dep-cont">
        <div class="landing-screen-int">
          ...
          <h2 style="font-family: 'Ubuntu', sans-serif; font-size:2.5rem;" class="dep-page-header">Food Technology​</h2>
        </div>
      </div>
    </section>
      ...
      <div class="fnt-setting p-5 bg-white rounded mb-5">
        ...
        <div id="myTabContent" class="tab-content">
          <div id="About" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade px-4 py-5 show active">
            ...
            <p class="fnt-setting">To create self-motivated quality Engineers and technocrats to contribute effectively
              to value based society and in the field of Food Technology.</p>

            <h3 style="font-weight: 600;font-family: 'Montserrat', sans-serif; font-size:1.5rem;" class="fnt-set-pro">
              Mission Statements</h3>
            <hr class="devd-dep-inln">
            <p>
              To catalyze and inspire young minds for innovative thinking and creativity and to acquire knowledge and
              professional ethics essential for facing global challenges in rapidly changing technologies to serve the
              society and industry effectively.
            </p>
            ...
            <hr class="devd-dep-inln">
            <ol>
              <li>To prepare students for academic competence, to be employed as Food Technology​​ professionals, for
                industry,
                higher studies, research, entrepreneurship and to significantly contribute to the society at large.</li>
              <li>To develop students’ fundamental knowledge related to Food Technology​ and to make them capable of
                providing solutions to challenging problems and
              ...
              <li>To enrich students with soft skills, leadership skills, professional skills and work ethics to make
                them good Food Technology​ professionals and role models for future generations.</li>
          ...
          <div id="Faculty" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
            ...
            <div style="margin-bottom: 3%;">
              ...
              <hr class="devd-dep-inln">
              <p class="fnt-setting">At Government Polytechnic Malvan, the Food Technology​​ department is privileged
    ...
    $strSQL = "SELECT * FROM hod_data WHERE deptname = 'ftech'";

    $rs = mysqli_query($conn, $strSQL);

    while ($row = mysqli_fetch_array($rs)) {
        //Display Logged user info
        $result = $conn->query("SELECT * FROM hod_data WHERE deptname = 'ftech'");
    }
    ...
    ?>
            <div>
              <div class="dept-container">
                <img src="people/ftech_hod.jpg" alt="Head of Department Photo" class="dept-photo img-fluid rounded">
                <div class="dept-info">
        ...
        $sql = "SELECT id, photo, name, education, designation, experience, message FROM faculty WHERE department='fte'";
                ...
                <tr style="height: 81px;">
                  <td style="height: 81px; width: 28%;">&nbsp;
                    <table>
                      <tbody>
                        <tr>
                          <td><strong>Food Technology​</strong></td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
...
// SQL query to fetch lab_name and incharge where deptname is 'Food Technology'
$sql = "SELECT lab_name, incharge FROM labs WHERE deptname = 'ftech'";
$result = $conn->query($sql);
...
?>
          ...
          <div id="newsletter" role="tabpanel" aria-labelledby="contact-tab" class="tab-pane fade px-4 py-5">
            ...
            <ul class="newsletter-links ul-imp-dt">
              ...
              <?php
    include "partials/_dbconnect.php";
    $strSQL = "SELECT * FROM newsletter WHERE deptname = 'ftech'";

    $rs = mysqli_query($conn, $strSQL);

    while ($row = mysqli_fetch_array($rs)) {
        //Display Logged user info
        $result = $conn->query("SELECT * FROM newsletter WHERE deptname = 'ftech'");
    }
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
    ?>
