...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    while ($row = mysqli_fetch_array($rs)) {
        ...
        $result = $conn->query("UPDATE personname SET minister ='" . $_POST['minister'] . "', secretory='" . $_POST['secretory'] . "', directordte='" . $_POST['directordte'] . "', jointdirectordte='" . $_POST['jointdirectordte'] . "' ,principle='" . $_POST['principle']. "' WHERE nmeid = 'gpmsid' ");
    }
                            ...
                            <div class="card">
                                ...
                                <div class=" card-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                            Minister Higher & Secondary Education

                                            </div>
                                            <div class="col-6">
                                                <?php echo $row['minister']; ?>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                Secretory Higher & Secondary Education

                                            </div>
                                            <div class="col-6">
                                                <?php echo $row['secretory']; ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class=" card-body">
                                        <div class="form-validation">
                                            <form class="form-valide" action="/loginsystem/update_testamonial.php"
                                                method="post">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="minister">Minister Higher & Secondary Education <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="minister" name="minister"
                                                            placeholder="Minister Higher & Secondary Education">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="secretory">Secretory Higher & Secondary Education
                                                        Detail <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="secretory"
                                                            name="secretory" placeholder="Secretory Higher & Secondary Education">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="directordte" >Director DTE <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="directordte" name="directordte"
                                                            placeholder="Director DTE">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="jointdirectordte">Director MSBTE RO
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"
                                                            id="jointdirectordte" name="jointdirectordte"
                                                            placeholder="Director MSBTE RO">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="Principle">Principal
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="principle"
                                                            name="principle" placeholder="Principal">
                                                    </div>
                                                </div>
