...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    while ($row = mysqli_fetch_array($rs)) {
        ...
        $result = $conn->query("UPDATE principal_desk SET name ='" . $_POST['name'] . "', dob='" . $_POST['dob'] . "', education='" . $_POST['education'] . "', experiance='" . $_POST['experiance'] . "' ,areas_intrest='" . $_POST['areas_intrest'] . "' ,phone='" . $_POST['phone']. "' WHERE nmeid = 'gpmsid' ");
    }
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card">
                                <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Principal's Details</h4>
                                ...
                                <div class=" card-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <?php echo nl2br($row['areas_intrest']); ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <small style=" margin-left: 3%; text-align:center; color:red" class="">(*Do Not Keep Field Empty!) (*To break a sentence/add to new line kindly add '\n' after each prompt)</small>
                                    <div class=" card-body">
                                        <div class="form-validation">
                                            <form class="form-valide" action="/loginsystem/update_pdesk.php"
                                                method="post">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="education" >Education <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="experiance">Professional Experience	
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"
                                                            id="experiance" name="experiance"
                                                            placeholder="Professional Experience">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="areas_intrest">Areas of Interest in Research
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"
                                                            id="areas_intrest" name="areas_intrest"
                                                            placeholder="Areas of Interest in Research">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="phone">Phone No.
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
