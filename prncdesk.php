...
<head>
  ...
  <meta charset="utf-8">
  <title>Contact Us - Government Polytechnic Malvan</title>
  <!--Google Fonts-->
  ...
  <section style="margin-top: 5%;" id="title">
    <div class="container landing-screen-int">
      ...
      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;"
        class="page-sub-hd">Principal's Desk</h2>

    </div>

   <?php
    include "partials/_dbconnect.php";
    $strSQL = "SELECT * FROM principal_desk WHERE nmeid = 'gpmsid'";

    $rs = mysqli_query($conn, $strSQL);

    while ($row = mysqli_fetch_array($rs)) {
        //Display Logged user info
        $result = $conn->query("SELECT * FROM principal_desk WHERE nmeid = 'gpmsid'");
    }
 ...
 <section id="">
      <div class="container">
        ...
        <table border="1" width="100%" cellspacing="1" cellpadding="0">
          <tbody>
            <tr class="trt-prc-dsk">
              <td style="text-align:center;"> <img style="width:100%;" src="images/prc1.jpg" alt=""> </td>
              <td class="tableinsidecontent" style="padding-bottom:0; text-align:center">
                <h3><strong> <span class="highlight"><?php echo $row['name'] ?></span>
                  </strong></h3>
              </td>
            </tr>
            <tr class="trt-prc-dsk">
              <td style="text-align:center;" class="tableinsidecontent" height="60"><strong>Date of birth</strong></td>
              <td style="text-align:center;" class="tableinsidecontent"><?php echo $row['dob'] ?></td>
            </tr>
            <tr class="trt-prc-dsk">
              <td style="text-align:center;" class="tableinsidecontent"><strong>Education</strong></td>
              <td style="text-align:center;" class="tableinsidecontent">
                <div style="margin-top:2%; margin-bottom:2%;" class=""><?php echo nl2br($row['education']) ?> </td>
      </div>
      </tr>
      <tr class="trt-prc-dsk">
        <td style="text-align:center;" class="tableinsidecontent"><strong>Present Status</strong></td>
        <td style="text-align:center;" class="tableinsidecontent">
          <div style="margin-top:2%; margin-bottom:2%;" class="">Principal of Government Polytechnic, Kumbharmath,
            Malvan-416606.<br />
      ...
      <tr class="trt-prc-dsk">
        <td style="text-align:center;" class="tableinsidecontent"><strong>Professional Experience</strong></td>
        <td style="text-align:center;" class="tableinsidecontent">
          <div style="margin-top:2%; margin-bottom:2%;" class=""> <?php echo nl2br($row['experiance']) ?>
          </div>
      </tr>

      <tr class="trt-prc-dsk">
        <td style="text-align:center;" class="tableinsidecontent" colspan="2" align="left" valign="top" height="20">
          <div style="margin-top:2%; margin-bottom:2%;" class=""><strong>Areas of Interest in Research</strong></p>
            <pstyle="text-align:center;"> <?php echo nl2br($row['areas_intrest']) ?>
        </td>
        </div>
      </tr>

      <tr class="trt-prc-dsk">
        <td style="text-align:center;" class="tableinsidecontent" colspan="2" align="left" valign="top" height="90">
          <div style="margin-top:2%;" class=""><strong>Contact Details :</strong></div>
          </p>
          <blockquote>
            <p>Phone No. (O) 0000-000000<br />
              Cell :+91 <?php echo $row['phone'] ?><br />
              Email: testmail@testmail.com</p>
        </td>
      </tr>
      </tbody>
      </table>
