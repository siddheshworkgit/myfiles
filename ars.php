...
$committee_id = 4; // set to the ID of the committee you are updating

// positions and their corresponding designations
$positions = [
    "Chairman Nodal officer" => "Chairman Nodal officer",
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card">
                                <h4 style=" margin-left: 3%; margin-top: 3%;" class="">Anti Ragging Squad
                                </h4>
