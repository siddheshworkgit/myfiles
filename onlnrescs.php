...
<header>
  ...
  <section style="margin-top: 5%;" id="title">
    ...
    <div class="container landing-screen-int">
      ...
      <h2 style=" text-decoration: underline;margin-top: 5%;font-family: 'Fredoka One', cursive; font-size:2.8rem;" class="page-sub-hd">Online Resourse / Computer Science</h2>
      ...
      <div class="fnt-setting p-5 bg-white rounded mb-5">
        ...
        <ul id="myTab" role="tablist" class="nav nav-tabs nav-pills flex-column flex-sm-row text-center bg-light border-0 rounded-nav">
          <li class="nav-item flex-sm-fill">
            <a id="home-tab" data-toggle="tab" href="#About" role="tab" aria-controls="home" aria-selected="true" class="nav-link bgnav border-0 text-uppercase font-weight-bold active">FY Computer</a>
          </li>
          <li class="nav-item flex-sm-fill">
            <a id="profile-tab" data-toggle="tab" href="#Structure" role="tab" aria-controls="profile" aria-selected="false" class="nav-link bgnav border-0 text-uppercase font-weight-bold">SY Computer</a>
          </li>
          <li class="nav-item flex-sm-fill">
            <a id="contact-tab" data-toggle="tab" href="#Laborotary" role="tab" aria-controls="contact" aria-selected="false" class="nav-link bgnav border-0 text-uppercase font-weight-bold">TY Computer</a>
          </li>
        </ul>
        <div id="myTabContent" class="tab-content">
          <div id="About" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade px-4 py-5 show active">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td> <a href="#">Meterial Name(Subject)</a> </td>
                  <td> <a href="#">Meterial Name(Subject)</a> </td>
                </tr>
                <tr>
                  <td> <a href="#">Meterial Name(Subject)</a> </td>
